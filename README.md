...
This repository is the official Vibedata Skills Marketplace. Build a skill using the [Skill Builder] (https://github.com/accelerate-data/vibedata-plugins-official). Skills developed in Skill Builder can be imported into Vibedata for builder, deploy and operator agents. 
...
The marketplace URL defaults to this repository (`https://github.com/accelerate-data/vibedata-plugins-official`) and can be changed in **Settings → Marketplace URL** to point to a private or team repository.
